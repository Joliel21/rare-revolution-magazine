...
- `articles.json` contains 33 article records.
- `source/medical.csv` preserves the uploaded source CSV.
...
- This series is part of the current RARE INSIGHTS manifest.
